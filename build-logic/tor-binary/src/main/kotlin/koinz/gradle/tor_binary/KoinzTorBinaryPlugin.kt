...
import koinz.gradle.tasks.PgpFingerprint
import koinz.gradle.tasks.download.SignedBinaryDownloader
...
class KoinzTorBinaryPlugin : Plugin<Project> {
    companion object {
        const val DOWNLOADS_DIR = "tor_binary/downloads"
    }

    override fun apply(project: Project) {
        val extension = project.extensions.create<KoinzTorBinaryPluginExtension>("tor")
