...
class TorBinaryPackager(private val project: Project) {
    ...
    companion object {
        private const val ARCHIVE_EXTRACTION_DIR = "${KoinzTorBinaryPlugin.DOWNLOADS_DIR}/extracted"
        private const val PROCESSED_DIR = "${KoinzTorBinaryPlugin.DOWNLOADS_DIR}/processed"
    }
