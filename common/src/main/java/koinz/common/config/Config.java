...
public class Config {
    ...
    private static BaseCurrencyNetwork BASE_CURRENCY_NETWORK_VALUE = BaseCurrencyNetwork.KOINZ_MAINNET;
     ...
     * itself.
     * @param defaultAppName typically "KOINZ" or similar
    ...
    public Config(String defaultAppName, File defaultUserDataDir, String... args) {
        ...
        ArgumentAcceptingOptionSpec<Enum> baseCurrencyNetworkOpt =
                parser.accepts(BASE_CURRENCY_NETWORK, "Base currency network")
                        ...
                        .defaultsTo(BaseCurrencyNetwork.KOINZ_MAINNET);
        ...
        ArgumentAcceptingOptionSpec<String> bitcoinRegtestHostOpt =
                parser.accepts(BITCOIN_REGTEST_HOST, "Bitcoin Core node when using KOINZ_REGTEST network")
                        .withRequiredArg()
                        .ofType(String.class)
                        .describedAs("host[:port]")
                        .defaultsTo("");
        ...
        ArgumentAcceptingOptionSpec<Boolean> useLocalhostForP2POpt =
                parser.accepts(USE_LOCALHOST_FOR_P2P, "Use localhost P2P network for development. Only available for non-KOINZ_MAINNET configuration.")
    ...
    private static String randomAppName() {
        try {
            File file = Files.createTempFile("KOINZ", "Temp").toFile();
     ...
     * {@link BaseCurrencyNetwork#KOINZ_MAINNET} or the value assigned via the
