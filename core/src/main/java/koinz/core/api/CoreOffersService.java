...
import koinz.core.api.exception.NotFoundException;
import koinz.core.monetary.Altcoin;
...
import static koinz.common.util.MathUtils.exactMultiply;
import static koinz.common.util.MathUtils.roundDoubleToLong;
import static koinz.common.util.MathUtils.scaleUpByPowerOf10;
import static koinz.core.locale.CurrencyUtil.apiSupportsCryptoCurrency;
import static koinz.core.locale.CurrencyUtil.isCryptoCurrency;
import static koinz.core.locale.CurrencyUtil.isFiatCurrency;
import static koinz.core.offer.Offer.State;
import static koinz.core.offer.OfferDirection.BUY;
import static koinz.core.offer.OfferDirection.SELL;
import static koinz.core.offer.OfferUtil.getRandomOfferId;
import static koinz.core.offer.OpenOffer.State.AVAILABLE;
import static koinz.core.offer.OpenOffer.State.DEACTIVATED;
import static koinz.core.payment.PaymentAccountUtil.isPaymentAccountValidForOffer;
import static koinz.core.util.PriceUtil.getMarketPriceAsLong;
import static koinz.proto.grpc.EditOfferRequest.EditType;
import static koinz.proto.grpc.EditOfferRequest.EditType.FIXED_PRICE_AND_ACTIVATION_STATE;
import static koinz.proto.grpc.EditOfferRequest.EditType.FIXED_PRICE_ONLY;
