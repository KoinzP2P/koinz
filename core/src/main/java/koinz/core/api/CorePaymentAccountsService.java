...
import koinz.core.api.model.PaymentAccountForm;
...
import koinz.core.payment.InstantCryptoCurrencyAccount;
...
import static koinz.common.app.DevEnv.isDaoTradingActivated;
import static koinz.common.config.Config.baseCurrencyNetwork;
import static koinz.core.locale.CurrencyUtil.apiSupportsCryptoCurrency;
import static koinz.core.locale.CurrencyUtil.findAsset;
import static koinz.core.locale.CurrencyUtil.getCryptoCurrency;
...
class CorePaymentAccountsService {
    ...
    private void verifyCryptoCurrencyAddress(String cryptoCurrencyCode, String address) {
        if (cryptoCurrencyCode.equals("KNZ")) {
