...
import koinz.core.api.exception.AlreadyExistsException;
import koinz.core.api.exception.FailedPreconditionException;
import koinz.core.api.exception.NotAvailableException;
import koinz.core.api.exception.NotFoundException;
import koinz.core.api.model.AddressBalanceInfo;
import koinz.core.api.model.BalancesInfo;
import koinz.core.api.model.BsqBalanceInfo;
import koinz.core.api.model.BtcBalanceInfo;
import koinz.core.api.model.TxFeeRateInfo;
import koinz.core.app.AppStartupState;
import koinz.core.btc.Balances;
import koinz.core.btc.exceptions.AddressEntryException;
import koinz.core.btc.exceptions.BsqChangeBelowDustException;
import koinz.core.btc.exceptions.InsufficientFundsException;
...
import koinz.core.btc.model.BsqTransferModel;
import koinz.core.btc.wallet.BsqTransferService;
...
import static koinz.core.util.ParsingUtils.parseToCoin;
...
class CoreWalletsService {
    ...
    private void verifyWalletCurrencyCodeIsValid(String currencyCode) {
        ...
        if (!currencyCode.equalsIgnoreCase("KNZ")
