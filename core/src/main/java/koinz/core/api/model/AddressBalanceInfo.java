...
public class AddressBalanceInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.AddressBalanceInfo toProtoMessage() {
        return koinz.proto.grpc.AddressBalanceInfo.newBuilder()
                .setAddress(address)
                .setBalance(balance)
    ...
    public static AddressBalanceInfo fromProto(koinz.proto.grpc.AddressBalanceInfo proto) {
