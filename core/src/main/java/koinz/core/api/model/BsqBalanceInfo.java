...
public class BsqBalanceInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.BsqBalanceInfo toProtoMessage() {
        return koinz.proto.grpc.BsqBalanceInfo.newBuilder()
    ...
    public static BsqBalanceInfo fromProto(koinz.proto.grpc.BsqBalanceInfo proto) {
