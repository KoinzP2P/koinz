...
import koinz.core.api.model.builder.BsqSwapTradeInfoBuilder;
...
public class BsqSwapTradeInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.BsqSwapTradeInfo toProtoMessage() {
        return koinz.proto.grpc.BsqSwapTradeInfo.newBuilder()
    ...
    public static BsqSwapTradeInfo fromProto(koinz.proto.grpc.BsqSwapTradeInfo proto) {
        return new BsqSwapTradeInfoBuilder()
