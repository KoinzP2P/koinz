...
public class BtcBalanceInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.BtcBalanceInfo toProtoMessage() {
        return koinz.proto.grpc.BtcBalanceInfo.newBuilder()
    ...
    public static BtcBalanceInfo fromProto(koinz.proto.grpc.BtcBalanceInfo proto) {
