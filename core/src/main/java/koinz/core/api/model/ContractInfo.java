...
import static koinz.core.api.model.PaymentAccountPayloadInfo.emptyPaymentAccountPayload;
...
public class ContractInfo implements Payload {
    ...
    public static ContractInfo fromProto(koinz.proto.grpc.ContractInfo proto) {
    ...
    @Override
    public koinz.proto.grpc.ContractInfo toProtoMessage() {
        return koinz.proto.grpc.ContractInfo.newBuilder()
