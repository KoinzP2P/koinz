...
import koinz.core.api.model.builder.OfferInfoBuilder;
...
public class OfferInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.OfferInfo toProtoMessage() {
        return koinz.proto.grpc.OfferInfo.newBuilder()
                .setId(id)
    ...
    public static OfferInfo fromProto(koinz.proto.grpc.OfferInfo proto) {
        return new OfferInfoBuilder()
                .withId(proto.getId())
