...
public class PaymentAccountPayloadInfo implements Payload {
    ...
    public static PaymentAccountPayloadInfo fromProto(koinz.proto.grpc.PaymentAccountPayloadInfo proto) {
    ...
    @Override
    public koinz.proto.grpc.PaymentAccountPayloadInfo toProtoMessage() {
        return koinz.proto.grpc.PaymentAccountPayloadInfo.newBuilder()
                .setId(id)
