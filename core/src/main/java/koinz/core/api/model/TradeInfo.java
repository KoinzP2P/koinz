...
import static koinz.core.api.model.BsqSwapTradeInfo.toBsqSwapTradeInfo;
import static koinz.core.api.model.OfferInfo.toMyInactiveOfferInfo;
import static koinz.core.api.model.OfferInfo.toOfferInfo;
import static koinz.core.api.model.PaymentAccountPayloadInfo.toPaymentAccountPayloadInfo;
import static koinz.core.offer.OfferDirection.BUY;
import static koinz.core.offer.OfferDirection.SELL;
import static koinz.core.util.PriceUtil.reformatMarketPrice;
import static koinz.core.util.VolumeUtil.formatVolume;
...
public class TradeInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.TradeInfo toProtoMessage() {
        var protoBuilder =
                koinz.proto.grpc.TradeInfo.newBuilder()
    ...
    public static TradeInfo fromProto(koinz.proto.grpc.TradeInfo proto) {
