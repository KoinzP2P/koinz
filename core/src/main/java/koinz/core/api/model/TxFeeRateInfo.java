...
public class TxFeeRateInfo implements Payload {
    ...
    @Override
    public koinz.proto.grpc.TxFeeRateInfo toProtoMessage() {
        return koinz.proto.grpc.TxFeeRateInfo.newBuilder()
    ...
    public static TxFeeRateInfo fromProto(koinz.proto.grpc.TxFeeRateInfo proto) {
