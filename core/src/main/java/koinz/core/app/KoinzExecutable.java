...
import koinz.core.setup.CorePersistedDataHost;
import koinz.core.setup.CoreSetup;
...
import koinz.core.trade.txproof.xmr.XmrTxProofService;
...
import koinz.common.config.BisqHelpFormatter;
import koinz.common.config.Config;
import koinz.common.config.ConfigException;
...
import koinz.common.setup.CommonSetup;
...
@Slf4j
public abstract class KoinzExecutable implements GracefulShutDownHandler, BisqSetup.BisqSetupListener, UncaughtExceptionHandler {
    ...
    public KoinzExecutable(String fullName, String scriptName, String appName, String version) {
