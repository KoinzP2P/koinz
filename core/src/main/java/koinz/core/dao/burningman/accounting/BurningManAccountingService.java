...
package koinz.core.dao.burningman.accounting;
...
import koinz.core.dao.burningman.accounting.blockchain.AccountingTx;
...
import koinz.core.dao.burningman.accounting.storage.BurningManAccountingStoreService;
        ...
        */
        return Arrays.stream(historical.split(", "))
                ...
                .collect(Collectors.toMap(tuple -> new Date(Long.parseLong(tuple[0])),
                        tuple -> Price.valueOf("KNZ", Long.parseLong(tuple[1]))));
    }
}
