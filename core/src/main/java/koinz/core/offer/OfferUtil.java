...
import koinz.core.payment.SameBankAccount;
import koinz.core.payment.SpecificBanksAccount;
...
import koinz.core.user.AutoConfirmSettings;
import koinz.core.user.Preferences;
import koinz.core.util.AveragePriceUtil;
...
import static koinz.core.btc.wallet.Restrictions.getMaxBuyerSecurityDepositAsPercent;
import static koinz.core.btc.wallet.Restrictions.getMinBuyerSecurityDepositAsPercent;
import static koinz.core.btc.wallet.Restrictions.getMinNonDustOutput;
import static koinz.core.btc.wallet.Restrictions.isDust;
import static koinz.core.offer.bisq_v1.OfferPayload.*;
...
public class OfferUtil {
    ...
    private final Predicate<String> isValidFeePaymentCurrencyCode = (c) ->
            c.equalsIgnoreCase("KNZ") || c.equalsIgnoreCase("BTC");
    ...
    public void maybeSetFeePaymentCurrencyPreference(String feeCurrencyCode) {
        if (!feeCurrencyCode.isEmpty()) {
            ...
            if (feeCurrencyCode.equalsIgnoreCase("KNZ") && preferences.isPayFeeInBtc())
        ...
        if (marketPrice != null && makerFee != null) {
            ...
            if (isCurrencyForMakerFeeBtc) {
                ...
                if (bsqPrice.isPositive()) {
                    ...
                    Volume makerFeeAsVolume = Volume.parse(inputValue, "KNZ");
