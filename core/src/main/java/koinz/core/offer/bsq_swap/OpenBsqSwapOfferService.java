...
import koinz.core.offer.placeoffer.bsq_swap.PlaceBsqSwapOfferModel;
import koinz.core.offer.placeoffer.bsq_swap.PlaceBsqSwapOfferProtocol;
...
import koinz.common.crypto.ProofOfWorkService;
...
public class OpenBsqSwapOfferService {
    ...
    public void requestNewOffer(String offerId,
        ...
        offerUtil.validateBasicOfferData(PaymentMethod.BSQ_SWAP, "KNZ");
