...
package koinz.core.proto.persistable;

import koinz.core.account.sign.SignedWitnessStore;
import koinz.core.account.witness.AccountAgeWitnessStore;
import koinz.core.btc.model.AddressEntryList;
import koinz.core.btc.wallet.BtcWalletService;
import koinz.core.dao.burningman.accounting.storage.BurningManAccountingStore;
import koinz.core.dao.governance.blindvote.MyBlindVoteList;
import koinz.core.dao.governance.blindvote.storage.BlindVoteStore;
import koinz.core.dao.governance.bond.reputation.MyReputationList;
import koinz.core.dao.governance.myvote.MyVoteList;
import koinz.core.dao.governance.proofofburn.MyProofOfBurnList;
import koinz.core.dao.governance.proposal.MyProposalList;
...
import koinz.core.dao.state.model.governance.BallotList;
import koinz.core.dao.state.storage.BsqBlockStore;
import koinz.core.dao.state.storage.DaoStateStore;
import koinz.core.dao.state.unconfirmed.UnconfirmedBsqChangeOutputList;
import koinz.core.payment.PaymentAccountList;
import koinz.core.proto.CoreProtoResolver;
import koinz.core.support.dispute.arbitration.ArbitrationDisputeList;
import koinz.core.support.dispute.mediation.MediationDisputeList;
import koinz.core.support.dispute.refund.RefundDisputeList;
import koinz.core.trade.model.TradableList;
import koinz.core.trade.statistics.TradeStatistics2Store;
import koinz.core.trade.statistics.TradeStatistics3Store;
import koinz.core.user.PreferencesPayload;
import koinz.core.user.UserPayload;

import koinz.network.p2p.mailbox.IgnoredMailboxMap;
import koinz.network.p2p.mailbox.MailboxMessageList;
import koinz.network.p2p.peers.peerexchange.PeerList;
import koinz.network.p2p.storage.persistence.RemovedPayloadsMap;
import koinz.network.p2p.storage.persistence.SequenceNumberMap;

import koinz.common.proto.ProtobufferRuntimeException;
import koinz.common.proto.network.NetworkProtoResolver;
import koinz.common.proto.persistable.NavigationPath;
import koinz.common.proto.persistable.PersistableEnvelope;
