...
import static koinz.core.trade.ClosedTradableUtil.*;
import static koinz.core.trade.model.bisq_v1.Trade.DisputeState.DISPUTE_CLOSED;
import static koinz.core.trade.model.bisq_v1.Trade.DisputeState.MEDIATION_CLOSED;
import static koinz.core.trade.model.bisq_v1.Trade.DisputeState.REFUND_REQUEST_CLOSED;
import static koinz.core.util.FormattingUtils.BTC_FORMATTER_KEY;
import static koinz.core.util.FormattingUtils.formatToPercentWithSymbol;
import static koinz.core.util.VolumeUtil.formatVolume;
import static koinz.core.util.VolumeUtil.formatVolumeWithCode;
