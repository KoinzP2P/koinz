...
public final class BsqSwapBuyerAsMakerTrade extends BsqSwapBuyerTrade implements MakerTrade {
    ...
    private BsqSwapBuyerAsMakerTrade(String uid,
                                     Offer offer,
                                     Coin amount,
                                     long takeOfferDate,
                                     NodeAddress peerNodeAddress,
    ...
    public protobuf.Tradable toProtoMessage() {
        return protobuf.Tradable.newBuilder()
                .setBsqSwapBuyerAsMakerTrade(protobuf.BsqSwapBuyerAsMakerTrade.newBuilder()
                        .setBsqSwapTrade((protobuf.BsqSwapTrade) super.toProtoMessage()))
                .build();
    }

    public static Tradable fromProto(protobuf.BsqSwapBuyerAsMakerTrade bsqSwapTrade) {
        var proto = bsqSwapTrade.getBsqSwapTrade();
        var uid = ProtoUtil.stringOrNullFromProto(proto.getUid());
        if (uid == null) {
            uid = UUID.randomUUID().toString();
        }
        return new BsqSwapBuyerAsMakerTrade(
                uid,
