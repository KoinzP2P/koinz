...
@Slf4j
public final class BsqSwapBuyerAsTakerTrade extends BsqSwapBuyerTrade implements TakerTrade {
    public BsqSwapBuyerAsTakerTrade(Offer offer,
                                    Coin amount,
    ...
    private BsqSwapBuyerAsTakerTrade(String uid,
                                     Offer offer,
                                     Coin amount,
                                     long takeOfferDate,
                                     NodeAddress peerNodeAddress,
    ...
    public protobuf.Tradable toProtoMessage() {
        return protobuf.Tradable.newBuilder()
                .setBsqSwapBuyerAsTakerTrade(protobuf.BsqSwapBuyerAsTakerTrade.newBuilder()
                        .setBsqSwapTrade((protobuf.BsqSwapTrade) super.toProtoMessage()))
                .build();
    }

    public static Tradable fromProto(protobuf.BsqSwapBuyerAsTakerTrade bsqSwapTrade) {
        var proto = bsqSwapTrade.getBsqSwapTrade();
        var uid = ProtoUtil.stringOrNullFromProto(proto.getUid());
        if (uid == null) {
            uid = UUID.randomUUID().toString();
        }
        return new BsqSwapBuyerAsTakerTrade(
                uid,
