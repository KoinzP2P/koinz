...
@Slf4j
public class BuyerAsMakerCreatesAndSignsFinalizedTx extends BuyerCreatesAndSignsFinalizedTx {
    @SuppressWarnings({"unused"})
    public BuyerAsMakerCreatesAndSignsFinalizedTx(TaskRunner<BsqSwapTrade> taskHandler,
