...
@Slf4j
public class BuyerAsTakerCreatesBsqInputsAndChange extends BuyerCreatesBsqInputsAndChange {

    @SuppressWarnings({"unused"})
    public BuyerAsTakerCreatesBsqInputsAndChange(TaskRunner<BsqSwapTrade> taskHandler, BsqSwapTrade bsqSwapTrade) {
