...
public class TxValidatorTakerBsqFeeTests {
    ...
    void feeUnconfirmedAfterEightHours(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        ...
        TxValidator txValidator1 = txValidator.validateBsqFeeTx(false);
    ...
    @Test
    void takerFeeAmountExactMatch(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        Tx tx = mock(Tx.class);
    ...
    @Test
    void takerFeeAmountHigherThanExpected(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        Tx tx = mock(Tx.class);
    ...
    @Test
    void takerFeeWithinTolerance(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        Tx tx = mock(Tx.class);
    ...
    @Test
    void takerPassFilterFeeCheck(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        Tx tx = mock(Tx.class);
        doReturn(4900L).when(tx).getBurntBsq();
        doReturn(Optional.of(tx)).when(daoStateService).getTx(anyString());
        ...
        doReturn(5_000_000L).when(filter).getTakerFeeBsq();
    ...
    @Test
    void takerFailFilterFeeCheck(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        Tx tx = mock(Tx.class);
        doReturn(4900L).when(tx).getBurntBsq();
        doReturn(Optional.of(tx)).when(daoStateService).getTx(anyString());
        ...
        Filter filter = mock(Filter.class);
        doReturn(10_000_000L).when(filter).getTakerFeeBsq();
        doReturn(filter).when(filterManager).getFilter();
    ...
    @Test
    void takerNoFilterFeeMatchesDifferentDaoParameter(@Mock DaoStateService daoStateService,
    ...
    @Test
    void takerNoFilterFeeTooLow(@Mock DaoStateService daoStateService, @Mock FilterManager filterManager) {
        Tx tx = mock(Tx.class);
        doReturn(4900L).when(tx).getBurntBsq();
        doReturn(Optional.of(tx)).when(daoStateService).getTx(anyString());
