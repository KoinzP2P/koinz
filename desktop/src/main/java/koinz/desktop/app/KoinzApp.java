...
import koinz.desktop.main.debug.DebugView;
import koinz.desktop.main.overlays.popups.Popup;
import koinz.desktop.main.overlays.windows.BsqEmptyWalletWindow;
import koinz.desktop.main.overlays.windows.BtcEmptyWalletWindow;
import koinz.desktop.main.overlays.windows.FilterWindow;
import koinz.desktop.main.overlays.windows.supporttool.SupportToolWindow;
import koinz.desktop.main.overlays.windows.SendAlertMessageWindow;
...
import koinz.desktop.util.CssTheme;
import koinz.desktop.util.DisplayUtils;
import koinz.desktop.util.ImageUtil;
...
import koinz.common.setup.UncaughtExceptionHandler;
...
import static koinz.common.crypto.Hash.getSha256Hash;
import static koinz.common.util.Utilities.encodeToHex;
import static koinz.desktop.util.Layout.INITIAL_WINDOW_HEIGHT;
import static koinz.desktop.util.Layout.INITIAL_WINDOW_WIDTH;
import static koinz.desktop.util.Layout.MIN_WINDOW_HEIGHT;
import static koinz.desktop.util.Layout.MIN_WINDOW_WIDTH;

@Slf4j
public class KoinzApp extends Application implements UncaughtExceptionHandler {
    @Setter
