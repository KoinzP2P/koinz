...
import koinz.desktop.components.paymentmethods.data.JapanBankData;
import koinz.desktop.util.validation.JapanBankAccountNameValidator;
import koinz.desktop.util.validation.JapanBankAccountNumberValidator;
import koinz.desktop.util.validation.JapanBankBranchCodeValidator;
import koinz.desktop.util.validation.JapanBankBranchNameValidator;
...
import koinz.core.payment.JapanBankAccount;
