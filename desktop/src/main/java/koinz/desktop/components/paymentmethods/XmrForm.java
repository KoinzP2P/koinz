...
import koinz.core.payment.XmrAccountDelegate;
...
import koinz.asset.CryptoNoteAddressValidator;
...
import static koinz.core.xmr.knaccc.monero.address.WalletAddress.PUBLIC_ADDRESS_PREFIX;
import static koinz.desktop.util.DisplayUtils.createAssetsAccountName;
...
import static koinz.desktop.util.FormBuilder.addLabelCheckBox;
