...
package koinz.desktop.main.account.content.backup;
...
import koinz.core.support.dispute.mediation.logs.LogFilesFinder;
import koinz.core.support.dispute.mediation.logs.LogFilesZipper;
...
public class BackupView extends ActivatableView<GridPane, Void> {
    ...
    private BackupView(Preferences preferences, Config config) {
        ...
        logFile = new File(Paths.get(dataDir.getPath(), "koinz.log").toString());
    }
