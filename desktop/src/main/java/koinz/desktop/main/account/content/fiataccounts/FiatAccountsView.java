...
package koinz.desktop.main.account.content.fiataccounts;
...
import koinz.desktop.components.paymentmethods.AchTransferForm;
import koinz.desktop.components.paymentmethods.AdvancedCashForm;
import koinz.desktop.components.paymentmethods.AliPayForm;
import koinz.desktop.components.paymentmethods.AmazonGiftCardForm;
import koinz.desktop.components.paymentmethods.AustraliaPayidForm;
import koinz.desktop.components.paymentmethods.BizumForm;
import koinz.desktop.components.paymentmethods.CapitualForm;
import koinz.desktop.components.paymentmethods.CashByMailForm;
import koinz.desktop.components.paymentmethods.CashDepositForm;
import koinz.desktop.components.paymentmethods.CelPayForm;
import koinz.desktop.components.paymentmethods.ChaseQuickPayForm;
import koinz.desktop.components.paymentmethods.ClearXchangeForm;
import koinz.desktop.components.paymentmethods.DomesticWireTransferForm;
import koinz.desktop.components.paymentmethods.F2FForm;
import koinz.desktop.components.paymentmethods.FasterPaymentsForm;
import koinz.desktop.components.paymentmethods.HalCashForm;
import koinz.desktop.components.paymentmethods.ImpsForm;
import koinz.desktop.components.paymentmethods.InteracETransferForm;
import koinz.desktop.components.paymentmethods.JapanBankTransferForm;
import koinz.desktop.components.paymentmethods.MercadoPagoForm;
import koinz.desktop.components.paymentmethods.MoneseForm;
import koinz.desktop.components.paymentmethods.MoneyBeamForm;
import koinz.desktop.components.paymentmethods.MoneyGramForm;
import koinz.desktop.components.paymentmethods.NationalBankForm;
import koinz.desktop.components.paymentmethods.NeftForm;
import koinz.desktop.components.paymentmethods.NequiForm;
import koinz.desktop.components.paymentmethods.PaxumForm;
import koinz.desktop.components.paymentmethods.PaymentMethodForm;
import koinz.desktop.components.paymentmethods.PayseraForm;
import koinz.desktop.components.paymentmethods.PaytmForm;
import koinz.desktop.components.paymentmethods.PerfectMoneyForm;
import koinz.desktop.components.paymentmethods.PixForm;
import koinz.desktop.components.paymentmethods.PopmoneyForm;
import koinz.desktop.components.paymentmethods.PromptPayForm;
import koinz.desktop.components.paymentmethods.RevolutForm;
import koinz.desktop.components.paymentmethods.RtgsForm;
import koinz.desktop.components.paymentmethods.SameBankForm;
import koinz.desktop.components.paymentmethods.SatispayForm;
import koinz.desktop.components.paymentmethods.SbpForm;
import koinz.desktop.components.paymentmethods.SepaForm;
import koinz.desktop.components.paymentmethods.SepaInstantForm;
import koinz.desktop.components.paymentmethods.SpecificBankForm;
import koinz.desktop.components.paymentmethods.StrikeForm;
import koinz.desktop.components.paymentmethods.SwiftForm;
import koinz.desktop.components.paymentmethods.SwishForm;
import koinz.desktop.components.paymentmethods.TikkieForm;
import koinz.desktop.components.paymentmethods.TransferwiseForm;
import koinz.desktop.components.paymentmethods.TransferwiseUsdForm;
import koinz.desktop.components.paymentmethods.USPostalMoneyOrderForm;
import koinz.desktop.components.paymentmethods.UpholdForm;
import koinz.desktop.components.paymentmethods.UpiForm;
import koinz.desktop.components.paymentmethods.VerseForm;
import koinz.desktop.components.paymentmethods.WeChatPayForm;
import koinz.desktop.components.paymentmethods.WesternUnionForm;
import koinz.desktop.main.account.content.PaymentAccountsView;
import koinz.desktop.main.overlays.popups.Popup;
import koinz.desktop.main.overlays.windows.ImportBisq2ProfileIdWindow;
import koinz.desktop.util.FormBuilder;
import koinz.desktop.util.GUIUtil;
import koinz.desktop.util.Layout;
import koinz.desktop.util.validation.AdvancedCashValidator;
import koinz.desktop.util.validation.AliPayValidator;
import koinz.desktop.util.validation.AustraliaPayidValidator;
...
import koinz.desktop.util.validation.InteracETransferValidator;
import koinz.desktop.util.validation.JapanBankTransferValidator;
...
import koinz.desktop.util.validation.PopmoneyValidator;
import koinz.desktop.util.validation.PromptPayValidator;
import koinz.desktop.util.validation.RevolutValidator;
import koinz.desktop.util.validation.SbpValidator;
import koinz.desktop.util.validation.SwishValidator;
...
import koinz.core.account.witness.AccountAgeWitnessUtils;
import koinz.core.locale.Res;
import koinz.core.offer.OfferRestrictions;
import koinz.core.payment.AmazonGiftCardAccount;
import koinz.core.payment.AustraliaPayidAccount;
import koinz.core.payment.CashByMailAccount;
import koinz.core.payment.CashDepositAccount;
...
import koinz.core.payment.WesternUnionAccount;
