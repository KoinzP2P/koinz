...
package koinz.desktop.main.dao.bonding;
...
import koinz.desktop.main.dao.bonding.dashboard.BondingDashboardView;
import koinz.desktop.main.dao.bonding.reputation.MyReputationView;
import koinz.desktop.main.dao.bonding.roles.RolesView;
...
public class BondingView extends ActivatableView<AnchorPane, Void> {
    ...
    public void initialize() {
        listener = (viewPath, data) -> {
            if (viewPath.size() != 4 || viewPath.indexOf(koinz.desktop.main.dao.bonding.BondingView.class) != 2)
                return;
        ...
        final List<Class<? extends View>> baseNavPath = Arrays.asList(MainView.class, DaoView.class, koinz.desktop.main.dao.bonding.BondingView.class);
