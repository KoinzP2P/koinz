...
package koinz.desktop.main.dao.economy.dashboard.price;

import koinz.desktop.components.chart.ChartDataModel;

import koinz.core.dao.state.DaoStateService;
import koinz.core.dao.state.model.blockchain.Tx;
import koinz.core.dao.state.model.governance.Issuance;
...
public class PriceChartDataModel extends ChartDataModel {
    ...
    double averageBsqUsdPrice() {
        return getAveragePriceFromDateFilter(tradeStatistics -> tradeStatistics.getCurrency().equals("KNZ") ||
    ...
    Map<Long, Double> getBsqUsdPriceByInterval() {
        ...
        bsqUsdPriceByInterval = getPriceByInterval(tradeStatistics -> tradeStatistics.getCurrency().equals("KNZ") ||
                        tradeStatistics.getCurrency().equals("USD"),
                PriceChartDataModel::getAverageBsqUsdPrice);
        return bsqUsdPriceByInterval;
    }
    ...
    Map<Long, Double> getBsqUsdMarketCapByInterval() {
        ...
        bsqUsdMarketCapByInterval = getBsqMarketCapByInterval(tradeStatistics -> tradeStatistics.getCurrency().equals("KNZ") ||
                        tradeStatistics.getCurrency().equals("USD"),
                PriceChartDataModel::getAverageBsqUsdPrice);
        return bsqUsdMarketCapByInterval;
    }
    ...
    Map<Long, Double> getBsqBtcPriceByInterval() {
        ...
        bsqBtcPriceByInterval = getPriceByInterval(tradeStatistics -> tradeStatistics.getCurrency().equals("KNZ"),
                PriceChartDataModel::getAverageBsqBtcPrice);
        return bsqBtcPriceByInterval;
    }
    ...
    Map<Long, Double> getBsqBtcMarketCapByInterval() {
        ...
        bsqBtcMarketCapByInterval = getBsqMarketCapByInterval(tradeStatistics -> tradeStatistics.getCurrency().equals("KNZ"),
                PriceChartDataModel::getAverageBsqBtcPrice);
        return bsqBtcMarketCapByInterval;
    }
    ...
    private static double getAverageBsqUsdPrice(List<TradeStatistics3> list) {
        ...
        for (TradeStatistics3 tradeStatistics : list) {
            if (tradeStatistics.getCurrency().equals("KNZ")) {
