...
package koinz.desktop.main.dao.governance;
...
import koinz.desktop.main.dao.bonding.BondingView;
import koinz.desktop.main.dao.bonding.bonds.BondsView;
...
import koinz.core.dao.governance.proposal.ProposalType;
import koinz.core.dao.governance.proposal.param.ChangeParamInputValidator;
...
import koinz.core.dao.state.model.governance.CompensationProposal;
...
public class ProposalDisplay {
        ...
        switch (proposalType) {
            ...
            case REMOVE_ASSET:
                ...
                List<Asset> assetList = CurrencyUtil.getSortedAssetStream()
                        .filter(e -> !e.getTickerSymbol().equals("KNZ"))
                        .collect(Collectors.toList());
    ...
    public void applyProposalPayload(Proposal proposal) {
        ...
        if (proposal instanceof CompensationProposal) {
            ...
            checkNotNull(assetComboBox, "assetComboBox must not be null");
            CurrencyUtil.findAsset(removeAssetProposal.getTickerSymbol(), BaseCurrencyNetwork.KOINZ_MAINNET)
                    .ifPresent(asset -> {
