...
import koinz.desktop.main.settings.SettingsView;
import koinz.desktop.main.settings.preferences.PreferencesView;
...
import koinz.core.util.validation.MonetaryValidator;
...
public abstract class MutableOfferViewModel<M extends MutableOfferDataModel> extends ActivatableWithDataModel<M> {
    ...
    private void applyMakerFee() {
        tradeFeeCurrencyCode.set(dataModel.isCurrencyForMakerFeeBtc() ? Res.getBaseCurrencyCode() : "KNZ");
    ...
    private MonetaryValidator getVolumeValidator() {
        ...
        if (CurrencyUtil.isCryptoCurrency(code)) {
            return code.equals("KNZ") ? bsqValidator : altcoinValidator;
        } else {
