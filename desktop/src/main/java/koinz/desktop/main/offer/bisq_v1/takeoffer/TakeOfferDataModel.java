...
import koinz.desktop.main.offer.bisq_v1.OfferDataModel;
...
import koinz.core.btc.TxFeeEstimationService;
...
class TakeOfferDataModel extends OfferDataModel {
  ...
  /*  private void setFeeFromFundingTx(Coin fee) {
    ...
    public boolean isAttemptToBuyBsq() {
        ...
        return !isBuyOffer() && getOffer().getCurrencyCode().equals("KNZ");
    }
}
