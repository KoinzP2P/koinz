...
import koinz.desktop.main.offer.bsq_swap.BsqSwapOfferView;
...
import static koinz.core.offer.bsq_swap.BsqSwapOfferModel.BSQ;
...
public class BsqSwapTakeOfferView extends BsqSwapOfferView<BsqSwapTakeOfferViewModel> implements InitializableViewWithTakeOfferData, SelectableView {
    ...
    private void maybeShowMissingFundsPopup() {
        if (!isMissingFundsPopupOpen) {
            ...
            String wallet = model.dataModel.isBuyer() ? "KNZ" : "BTC";
