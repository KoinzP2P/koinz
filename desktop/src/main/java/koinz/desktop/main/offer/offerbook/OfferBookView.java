...
import koinz.desktop.components.AccountStatusTooltipLabel;
...
import koinz.desktop.components.ColoredDecimalPlacesWithZerosText;
import koinz.desktop.components.HyperlinkWithIcon;
import koinz.desktop.components.InfoAutoTooltipLabel;
import koinz.desktop.components.PeerInfoIconMap;
import koinz.desktop.components.PeerInfoIconTrading;
...
import koinz.desktop.main.portfolio.editoffer.EditOfferView;
...
abstract public class OfferBookView<R extends GridPane, M extends OfferBookViewModel> extends ActivatableViewAndModel<R, M> {
    ...
    private void openPopupForMissingAccountSetup(Offer offer) {
        ...
        if (offer.getCurrencyCode().equals("KNZ")) {
