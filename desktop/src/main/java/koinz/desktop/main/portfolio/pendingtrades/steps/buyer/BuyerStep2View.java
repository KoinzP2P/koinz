...
package koinz.desktop.main.portfolio.pendingtrades.steps.buyer;

import koinz.desktop.components.AutoTooltipButton;
import koinz.desktop.components.BusyAnimation;
import koinz.desktop.components.SimpleMarkdownLabel;
import koinz.desktop.components.TextFieldWithCopyIcon;
...
import koinz.desktop.main.dao.wallet.BsqWalletView;
import koinz.desktop.main.dao.wallet.send.BsqSendView;
import koinz.desktop.main.overlays.popups.Popup;
import koinz.desktop.main.overlays.windows.SetXmrTxKeyWindow;
...
import koinz.core.network.MessageState;
...
public class BuyerStep2View extends TradeStepView {
    ...
    protected void addContent() {
        ...
        if (trade.getOffer().getCurrencyCode().equals("KNZ")) {
