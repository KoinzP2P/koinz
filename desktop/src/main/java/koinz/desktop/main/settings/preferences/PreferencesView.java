...
import koinz.desktop.main.overlays.windows.EditCustomExplorerWindow;
...
import koinz.core.util.validation.RegexValidatorFactory;
...
public class PreferencesView extends ActivatableViewAndModel<GridPane, PreferencesViewModel> {
    ...
    private void activateDisplayPreferences() {
        ...
        editCustomBsqExplorer.setOnAction(e -> {
            EditCustomExplorerWindow urlWindow = new EditCustomExplorerWindow("KNZ",
