...
- Build KOINZ from source (see [build.md](build.md))
- Setup a development/testing environment (see [Makefile](../Makefile) or [dev-setup.md](dev-setup.md))
- Request access to [TestPad](https://koinz.ontestpad.com) (our test management tool)

## Communication Channels

If you would like to discuss and/or contribute to KOINZ's testing effort, join us in the #testing channel within the [KOINZ Matrix Space](https://koinz.chat).
Here you could also request access to TestPad (https://koinz.ontestpad.com).

## Compensation

Testing activities are eligible for [compensation](https://koinz.wiki/Making_a_compensation_request).
...
[TestPad](https://koinz.ontestpad.com) is used to manage and track the manual testing process.
