...
package koinz.network.p2p.network;
...
import koinz.network.p2p.SendersNodeAddressMessage;
import koinz.network.p2p.SupportedCapabilitiesMessage;
import koinz.network.p2p.peers.keepalive.messages.KeepAliveMessage;
...
import koinz.common.app.HasCapabilities;
